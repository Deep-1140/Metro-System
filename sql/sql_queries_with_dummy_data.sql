...
-- Insert dummy data into user_profiles table (updated for Indore)
...
VALUES 
('indore_user1', 'g%&^%&^^&4ig^%7575634', 'USER', 'sess001', 1),
('indore_admin', 'g%&^%&^^&4ig^%7575634', 'ADMIN', 'sess002', 2),
('indore_user2', 'g%&^%&^^&4ig^%7575634', 'USER', 'sess003', 3);

-- Insert dummy data into train table (updated for Indore Metro)
...
VALUES 
('TICKET001', '2025-09-01', 'General', 2, 40.00, 'Booked', 'txn001', 201, 1),
('TICKET002', '2025-09-05', 'AC', 1, 25.00, 'Booked', 'txn002', 202, 2),
('TICKET003', '2025-09-10', 'General', 3, 54.00, 'Cancelled', 'txn003', 203, 1),
('TICKET004', '2025-09-15', 'AC', 2, 44.00, 'Booked', 'txn004', 204, 3),
('TICKET005', '2025-09-20', 'General', 4, 120.00, 'Booked', 'txn005', 205, 2);
